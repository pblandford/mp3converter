...
fun midiToWaveFile(
  ...
  val length = ((lengthMs * settings.sampleRate * 2) / 1000).toInt()
...
internal fun getSamples(eventSets: List<EventSet>, sampler: ISampler, settings: Settings): List<Sample> {
...
internal fun getSample(eventSet: EventSet, sampler: ISampler, settings: Settings): Sample {
