...
JNIEXPORT void JNICALL
Java_com_philblandford_mp3convertercore_engine_encode_LameEncoderKt_close(JNIEnv
                                                                      *env,
                                                                      jobject thiz) {
    if (gfp != NULL) {
        lame_close(gfp);
...
Java_com_philblandford_mp3convertercore_engine_encode_LameEncoderKt_encodeBytes(JNIEnv
                                                                            *env,
                                                                            jobject thiz,
